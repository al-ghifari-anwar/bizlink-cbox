...
class MEquipmentStatus extends CI_Model
{
    ...
    public function getExistingMixingTime($no_batch, $status_equipment, $name_equipment)
    {
        $result = $this->db->get_where('tb_mixing_time', ['no_batch' => $no_batch, 'status_equipment' => $status_equipment, 'name_equipment' => $name_equipment])->row_array();
    ...
    {
        $this->db->join('tb_spk', 'tb_spk.id_spk = tb_mixing_time.id_spk');
